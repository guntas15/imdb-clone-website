        ...
        <div className="container">
          <div className="grid-6 info-poster">
            ...
            <span className="genre">
              Browser ({data && data.known_for_department})
            </span>
            ...
            <span>Birth:{data && data.birthday} </span>

            {data && data.deathday != null && (
              <span>Passing: {data && data.deathday} </span>
            )}

            <span>Birthplace: {data && data.place_of_birth} </span>
          </div>
